...
const useModalStore = create<ModalState>((set) => ({
  ...
  toggleIsAddingTeam: () =>
    set((state) => ({ isAddingTeam: !state.isAddingTeam, idEditTeam: null })),
  ...
  toggleIsAddingMatch: () =>
    set((state) => ({ isAddingMatch: !state.isAddingMatch, idEditMatch: null })),
  ...
  toggleIsAddingPlayer: () =>
    set((state) => ({ isAddingPlayer: !state.isAddingPlayer, idEditPlayer: null })),
}))
